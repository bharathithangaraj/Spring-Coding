...
public class SwaggerAPIDocumentationConfig {
	...
	ApiInfo apiInfo() {
		return new ApiInfoBuilder().title("Person REST CRUD operations API in Spring-Boot 2")
				...
				.termsOfServiceUrl("").version("0.0.1-SNAPSHOT").contact(new Contact("Wavelabs", "https://github.com/hellosatish/monitoring/person", "https://github.com/hellosatish")).build();
	}
