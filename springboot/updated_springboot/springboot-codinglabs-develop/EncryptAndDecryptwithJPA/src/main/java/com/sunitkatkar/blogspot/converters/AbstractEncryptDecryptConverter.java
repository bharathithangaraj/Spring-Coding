...
public abstract class AbstractEncryptDecryptConverter<X> implements AttributeConverter<X, String> {
	...
	/**
	 * This is the key required for encrypt * This is the key required for
	 * encryption/decryption. This is defined here ion/decryption. This is defined
	 * here for example purpose. In production, this should come from a secure
	 * location not accessible easily. In Spring Boot, one possible location is the
