...
public class CipherMaker {
	...
	/**
	 * @param encryptionMode - decides whether to ecrypt or decrypt data. Values
	 *                       accepted: {@link Cipher#ENCRYPT_MODE} for encryption
	 *                       and {@link Cipher#DECRYPT_MODE} for decryption.
	 * @param key            - the key to use for encrypting or decrypting data.
	 *                       This can be a simple String like "MySecretKey" or a
	 *                       more complex, hard to guess longer string
	 * @return
